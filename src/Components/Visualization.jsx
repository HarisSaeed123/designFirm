...
import img1 from "../assets/Camera_05.jpg"
import img2 from "../assets/Camera_04.jpg"
    ...
    return (
        <>
            ...
            <ul id='menuLinks' className='menuList'>
                ...
                <li><Link to="/services/corporate">WORKPLACE</Link></li>
...
c3.3-11,21.2-26.6,49.8-26.6c35.5,0,63.3,23,63.3,72.4V508.1z"/>
        ...
        <div className="sideBarPhone">
          ...
          <dir>
            ...
            <div className="mainVisualPage" onMouseOver={() => {
                document.getElementById('menuLinks').classList.remove('show')
            }}>


                <div className='websiteHeading6'>
                    <h1>ATELIER / 75</h1>
                    <hr />
                </div>
                <div className="expertiseVisual">
                    <h1><span>Expertise</span> / Visualization</h1>
                </div>
                ...
                <div className='aboutVisualization'>
                    <h1>Visualization at Atelier 75</h1>
                    <p>In architecture, visualization serves as a bridge between imagination and reality, breathing life into design concepts and allowing us to perceive spaces before they are built. <span id="text17">At our architectural firm, we embrace the transformative power of visualization, harnessing state-of-the-art technology to create immersive and captivating experiences for our clients and stakeholders. Visualization is a cornerstone of our design process, enabling us to communicate ideas with unparalleled clarity and precision. Through advanced 3D modeling, rendering, and animation techniques, we bring architectural visions to life, presenting them in a visually stunning and engaging manner. Every detail, from textures and materials to lighting and spatial relationships, is meticulously crafted to provide an authentic representation of the final built environment.</span></p>
                    <span id='more14' onClick={() => {
                ...
                <div className="community6">
                    <h1>Where imagination finds its voice</h1>
                    <p>At &nbsp;Atelier 75, our team comprises skilled visualizers, architects, artists, and designers are dedicated to create exceptional interior and exterior renderings for yet to be constructed spaces. Our market leading visualization services are designed to captivate you and enhance your project success.</p>
                    <p><span id='text18'>Using cutting edge visualization softwares, our skilled architects craft impressive exterior and interior views of a building. These renderings include thoughtful addition that complement the architecture by presenting them in day and night views.</span></p>
                    <span id='more15' onClick={() => {
                    ...
                    <h1>"Our team members possess diverse backgrounds in architecture, exhibit design, product, and visualization. We boast a rich portfolio, having crafted everything from visual identities to custom interiors and impressive building facades."</h1>
                    <p>Danish Saeed | Architecture Visualizer</p>
                    <img src={img2} alt="" />
                    <img src={img1} alt="" />
                </div>
                <footer onMouseOver={() => {
