...
import img1 from "../assets/Executive Room Interior/Final 1.jpg"
import img2 from "../assets/nafeesa/Rejuvination Area (2).jpg"
import img3 from "../assets/nafeesa/Featured Wall.jpg"
import img4 from "../assets/nafeesa/Meeting Room.jpg"
import img5 from "../assets/portrat2.jpg"
...
c3.3-11,21.2-26.6,49.8-26.6c35.5,0,63.3,23,63.3,72.4V508.1z"/>
      ...
      <div className="aboutContainer" onMouseOver={() => {
        ...
        <div className="aboutText">
          <h1>We are a collective of architects, designers, engineers, and planners working together to build a better future.</h1>
        </div>
      ...
      <div className="textabout">
        <h1>Atelier <span>75</span></h1>
        <hr />
        <p id='firstPara'>Atelier 75, a design firm based in both Lahore and Dublin, specializes in Architecture, Interiors, and 3D Visualization. Founded in 2015 by Saad Khan, our firm serves as a dynamic platform for research and innovation, pushing the boundaries between architecture, interior design, and product design.</p>
        <p id='secondPara'><span id='cutOff'>Our design philosophy revolves around the creation of exceptional, practical, and inspiring spaces and objects. We strive to understand and respond to the intricate complexities of our lives, resulting in unique and thought-provoking outcomes. Rather than adhering to preconceived styles, we approach each project with a fresh perspective, challenging conventions and established norms. Through a comprehensive understanding of the elements and stakeholders that shape the design process, we embark on a journey of exploration and experimentation.

          At Atelier 75, we embrace the opportunity to integrate new technologies, reimagine the utilization of local crafts and materials, and craft spaces and products that bring joy to those who inhabit them. Every design challenge is viewed as a chance to discover and innovate, cultivating a sense of delight and discovery. Join us as we embark on a collaborative journey, where creativity, functionality, and forward-thinking converge to shape extraordinary environments and objects that transcend expectations.</span></p>
        <span onClick={() => {
          document.getElementById('cutOff').style.display = "block"
          document.getElementById('show').style.display = "none"
          document.getElementById('hide').style.display = "block"
        }} id='show'>See More...</span>
        <span onClick={() => {
          document.getElementById('cutOff').style.display = "none"
          document.getElementById('show').style.display = "block"
          document.getElementById('hide').style.display = "none"
        }} id='hide'>See Less</span>
      </div>
      ...
      <div className='portrait'>
        ...
        <div className="portraitText">
          <div className="childText">
            <h1>"We have always been about grasping into the future by balancing on a metaphorical tightrope, the studio fearlessly explores new horizons, relying on its expertise and precision to accomplish genuine breakthroughs in innovation."</h1>
            <p>Saad Bashir | Principal Architect</p>
            <hr />
          </div>
