...
import img from "../assets/hotelInterior/13.png"
import img1 from "../assets/hotelInterior/1) Lobby Lounge With Chandlier .jpg"
import img2 from "../assets/hotelInterior/4) Seating Space.jpg"
import img3 from "../assets/hotelInterior/3) Seating Space.jpg"
...
c3.3-11,21.2-26.6,49.8-26.6c35.5,0,63.3,23,63.3,72.4V508.1z"/>
        ...
        <div className="sideBarPhone">
          ...
          <dir>
            ...
            <div className="mainHospitalPage" onMouseOver={() => {
                document.getElementById('menuLinks').classList.remove('show')
            }}>


                <div className='websiteHeading7'>
                    <h1>ATELIER / 75</h1>
                    <hr />
                </div>
                <div className="expertiseHospital">
                    <h1><span>Expertise</span> / Hospitality</h1>
                </div>
                <div className="hospitalImage">
                    <img src={img} alt="" />
                </div>
                <div className='aboutHospitality'>
                    <h1>Hospitality at Atelier 75</h1>
                    <hr />
                    <p>Welcome to our world of hospitality interiors, where elegance meets comfort, creating unforgettable experiences for valued guests. Our meticulously designed spaces exude warmth and sophistication, making you feel at home while indulging in world class luxury. <span id='text19'>Whether it's the plush furnishings that invite you to relax, the artful blend of textures and colors that stir your senses, or the subtle lighting that sets the perfect mood, our interiors are crafted to leave a lasting impression. </span></p>
                    <span id='more16' onClick={() => {
                ...
                <div className="community7">
                    <h1>Remarkable destinations that make writing home an absolute delight.</h1>
                    <p>We specialize in crafting unforgettable environments for top tier hotel brands worldwide. Our designs blend elegance with cutting edge elements, elevating the guest experience to new heights. With extensive expertise in the hospitality industry, we've created exceptional spaces across various scales of hotel interiors to entire resort communities.</p>
                    <p><span id='text20'>Through a harmonious collaboration between our interior designers, architects, and engineers, we adopt a distinctive holistic approach to crafting the ultimate guest experience. Our worldwide presence, diverse range of skills, and accolade filled portfolio position us as the perfect choice for today's leading hospitality companies.</span></p>
                    <span id='more17' onClick={() => {
                    ...
                    <img src={img1} alt="" />
                    <h1>"We weave spaces that not only enchant the eyes but also the hearts. Our interiors are a celebration of the human spirit, where every detail tells a story of care and craftsmanship, creating moments that linger in memories forever."</h1>
                    <p>Ahmed Ali | Interior Designer</p>
                    <img src={img2} alt="" />
                    <img src={img3} alt="" />
                </div>
                <footer onMouseOver={() => {
