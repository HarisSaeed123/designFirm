...
import img4 from "../assets/advertisement.jpg"
import img5 from "../assets/sahq.jpg"
    ...
    return (
        <>
            ...
            <ul id='menuLinks' className='menuList'>
                ...
                <li><Link to="">FACADE DESIGN</Link></li>
...
c3.3-11,21.2-26.6,49.8-26.6c35.5,0,63.3,23,63.3,72.4V508.1z"/>
            ...
            <div className="mainFacadePage" onMouseOver={() => {
                document.getElementById('menuLinks').classList.remove('show')
            }}>


                <div className='websiteHeading5'>
                    <h1>ATELIER / 75</h1>
                    <hr />
                </div>
                <div className="expertiseFacade">
                    <h1><span>Expertise</span> / Facade Design</h1>
                </div>
                <div className="facadeImage">
                    <img src={img} alt="" />
                </div>
                <div className='aboutFacadeDesign'>
                    <h1>Facade Design at Atelier 75</h1>
                    <hr />
                    <p>In the realm of architectural design, few elements hold as much transformative power as the facade. It is the face of a building, the first impression that captures the attention and imagination of passersby. <span id='text15'>Our architectural firm understands the profound impact of facade design, and we embrace the opportunity to create visually stunning and conceptually meaningful exteriors that captivate and inspire. Each facade design we undertake is a testament to our commitment to pushing the boundaries of creativity and innovation. We approach every project with a keen understanding of its unique context, purpose, and aspirations. Our team of skilled architects and designers delves deep into the essence of the project, meticulously studying its surroundings, cultural influences, and functional requirements.</span></p>
                    <span id="more12" onClick={() => {
                ...
                <div className="community5">
                    <h1>Our approach delves deeper than the surface.</h1>
                    <p>Uniting our interdisciplinary knowledge in physics, material science, construction, and the art of composition, we meticulously tailor each facade to suit the unique local climate. Our aim is to exceed both performance requirements and aesthetic design aspirations.</p>
                    <p><span id='text16'>Throughout the design phase, we develop facade concepts with a keen focus on efficiency and performance. Our team of technical experts thoroughly analyzes every detail, taking into account factors such as thermal transfer, energy efficiency, air infiltration, moisture management, structural integrity, acoustics, life safety, and comfort. We subject the proposed solutions to rigorous testing, ensuring they are not only effective but also practical to construct.</span></p>
                    <span id='more13' onClick={() => {
                    ...
                    <img src={img1} alt="" />
                    <h1>"Achieving a remarkable facade design entails harmonizing diverse visual and performance aspects to arrive at a unified solution. This convergence, where aesthetics, materials, construction, and numerous other factors intersect, is where architecture truly becomes a fusion of design, technology, art, and science."</h1>
                    <p>Saqib Nazir | Technical Design Partner</p>
                    <img src={img2} alt="" />
                    <img src={img3} alt="" />
                </div>
                <div className="ads1">
