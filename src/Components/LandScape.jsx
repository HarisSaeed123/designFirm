...
import img from "../assets/landscape/5.png"
import img1 from "../assets/landscape/6.png"
import img2 from "../assets/landscape/3.png"
import img3 from "../assets/landscape/1.png"
    ...
    return (
        <>
            ...
            <ul id='menuLinks' className='menuList'>
                ...
                <li><Link to="">LANDSCAPE DESIGN</Link></li>
...
c3.3-11,21.2-26.6,49.8-26.6c35.5,0,63.3,23,63.3,72.4V508.1z"/>
        ...
        <div className="sideBarPhone">
          ...
          <dir>
            ...
            <div className="mainLandPage" onMouseOver={() => {
                document.getElementById('menuLinks').classList.remove('show')
            }}>


                <div className='websiteHeading2'>
                    <h1>ATELIER / 75</h1>
                    <hr />
                </div>
                <div className="expertiseLandScape">
                    <h1><span>Expertise</span> / LandScape</h1>
                </div>
                <div className="landscapeImage">
                    <img src={img} alt="" />
                </div>
                <div className='aboutLandScape'>
                    <h1>Landscape at Atelier 75</h1>
                    <hr />
                    <p>Welcome to our world of landscapes, where nature's canvas comes alive with vibrant colors and breathtaking beauty. At Atelier 75, we are passionate about transforming outdoor spaces into captivating havens that inspire, rejuvenate, and create unforgettable experiences. <span id='text6'>Imagine stepping into a realm where every sight, scent, and touch evokes a sense of wonder and tranquility. Our team of skilled landscape artists is dedicated to crafting immersive environments that seamlessly blend artistry and functionality. From sprawling gardens to intimate courtyards, we believe that every space has the potential to become a masterpiece.</span></p>
                    <span id='more6' onClick={() => {
                        document.getElementById('text6').style.display = "block"
                        document.getElementById('more6').style.display = "none"
                        document.getElementById('less6').style.display = "block"
                    }}>See More...</span>
                    <span id='less6' onClick={() => {
                        document.getElementById('text6').style.display = "none"
                        document.getElementById('more6').style.display = "block"
                        document.getElementById('less6').style.display = "none"
                    }}>See Less...</span>
                </div>
                <div className="community2">
                    <h1>Making places better</h1>
                    <p>The interdependence of landscape and ecology forms the core of our open space practice. By bridging these disciplines, we leverage our technical expertise to develop holistic solutions that rejuvenate and revitalize the natural environment. <span id='text7'>Our design approach encompasses a comprehensive perspective. It presents an opportunity to strengthen the bonds between individuals and their surroundings, nature, and the community at large.</span></p>
                    <p><span id='text8'>Our ultimate goal is to craft places that authentically embody local culture, while preserving and nurturing nature and fostering a seamless connection between the two.</span></p>
                    <span id='more7' onClick={() => {
                        ...
                        document.getElementById('less7').style.display = "block"
                    }}>See More...</span>
                    <span id="less7" onClick={() => {
                        document.getElementById('text7').style.display = "none"
                        document.getElementById('text8').style.display = "none"
                        document.getElementById('more7').style.display = "block"
                        document.getElementById('less7').style.display = "none"
                    }}>See Less...</span>
                    <img src={img1} alt="" />
                    <h1>"Our team's diverse expertise in regional planning, city design, waterfronts, urban parks, streetscapes, and various landscape projects forms the foundation of an encompassing strategy to design healthful environments."</h1>
                    <p>M. Adnan | Landscape Architect</p>
                    <img src={img2} alt="" />
                    <img src={img3} alt="" />
                </div>
