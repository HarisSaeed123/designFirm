...
import img from "../assets/01-3.jpg"
import img1 from "../assets/02-2.jpg"
import img2 from "../assets/advertisement.jpg"
import img3 from "../assets/sahq.jpg"
export default function Architecture() {
  ...
  return (
    <>
      ...
      <div className="mainArchitectPage" onMouseOver={() => {
...
c3.3-11,21.2-26.6,49.8-26.6c35.5,0,63.3,23,63.3,72.4V508.1z"/>
        ...
        <div className="expertiseArchitecture">
          <h1><span>Expertise</span> / Architecure</h1>
        </div>
        <div className="architectureImage">
          <img src={img} alt="" />
        </div>
        <div className='aboutArchitecture'>
          <h1>Architecture at Atelier 75</h1>
          <hr />
          <p>The architecture should have a forward thinking approach and strive to shape the future we desire to live in. We strongly believe that design has the power to drive positive environmental transformation. <span id='text'>Our efforts are dedicated to translate this vision into reality by creating buildings that surpass contemporary standards. Our practice seamlessly blends various disciplines such as architecture, engineering both structural and environmental, urbanism, interior and industrial design. Our collaborative working environment resembles a close knit university, where we work together from the beginning, learning from each other and combining our expertise to develop fully integrated design solutions.</span></p>
          <span id="more2" onClick={() => {
            document.getElementById('text').style.display = "block"
            document.getElementById('more2').style.display = "none"
            document.getElementById('less2').style.display = "block"
          }}>See more...</span>
          <span id='less2' onClick={() => {
        ...
        <div className="community">
          <h1>Strengthening community</h1>
          <p>Design has the potential to act as a driving force for positive environmental transformation. Our endeavor's aim is to manifest this vision of crafting buildings that surpass contemporary standards and contribute to a sustainable future. <span id='text1'>Moreover, the philosophy of producing buildings that are ahead of their time implies that these structures are not just future proof, but also trailblazers in sustainability.</span></p>

          <p><span id='text2'>Our design approach embraces a holistic outlook, providing a chance to foster deeper connections between people, their environment, the natural world, and the broader community.</span></p>
          <span id="more3" onClick={() => {
            document.getElementById('text1').style.display = "block"
            document.getElementById('text2').style.display = "block"
            document.getElementById('more3').style.display = "none"
            document.getElementById('less3').style.display = "block"
          }}>See more...</span>
          <span id='less3' onClick={() => {
          ...
          <img src={img1} alt="" />
          <h1>How can a structure promote a sense of community?<br /><br /> "Every project we undertake is seen as a chance to address these inquiries to discover how architecture can strengthen the feeling of belonging, enrich the public space, and prioritize the residents overall welfare."</h1>
          <p>M.Usman | Architect</p>
        </div>
        <div className="ads">
          <div>
            <img src={img2} alt="" />
            <p>Sahar Advertisement Agency, Lahore Pakistan</p>
          </div>
          <div>
            <img src={img3} alt="" />
          </div>
