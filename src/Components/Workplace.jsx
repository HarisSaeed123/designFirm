...
import img from "../assets/sehar/5) Marketing Room.jpg"
import img1 from "../assets/sehar/2) MEETING ROOM.jpg"
import img2 from "../assets/sehar/3) Accounts Department.jpg"
import img3 from "../assets/sehar/4) CEO Room.jpg"
...
c3.3-11,21.2-26.6,49.8-26.6c35.5,0,63.3,23,63.3,72.4V508.1z"/>
        ...
        <div className="sideBarPhone">
          ...
          <dir>
            ...
            <div className="mainEduPage" onMouseOver={() => {
                document.getElementById('menuLinks').classList.remove('show')
            }}>


                <div className='websiteHeading8'>
                    <h1>ATELIER / 75</h1>
                    <hr />
                </div>
                <div className="expertiseEducation">
                    <h1><span>Expertise</span> / Workplace</h1>
                </div>
                <div className="eduImage">
                    <img src={img} alt="" />
                </div>
                <div className='aboutEducation'>
                    <h1>Workplace at Atelier 75</h1>
                    <hr />
                    <p>As strategists, planners, and designers, our mission is to deeply comprehend the core of every organization we collaborate with. Utilizing an immersive process of data collection, exploration, and synthesis, we forge a comprehensive blueprint to empower its people to reach their fullest potential.</p>
                </div>
                <div className="community8">
                    <h1>We see workplace design as an opportunity to enrich the human experience.</h1>
                    <p>Our cross functional teams excel at leading companies through transformative workplace journeys, harmonizing with their mission, vision, brand, and culture. We create high performance environments that yield an enduring value. Embracing a profoundly collaborative ethos, we strategize design solutions that anticipate future needs, incorporate cutting edge technologies, and adapt to emerging trends.</p>
                    <p><span id="text21">Atelier 75 sets the standard for innovative design solutions, renowned for exceptional workplace creations that seamlessly integrate elements of health, wellness, functionality, durability, sustainability, and uncompromising quality into every intricate detail.</span></p>
                    <span id='more18' onClick={() => {
                    ...
                    <img src={img1} alt="" />
                    <h1>"With each passing year, we have pushed the boundaries of possibility, solidifying our standing as industry leaders in design, technology, and management within this esteemed market, it's a milestone that brings immense pride to our dedicated team."</h1>
                    <p>James Crook | Architect</p>
                    <img src={img2} alt="" />
                    <img src={img3} alt="" />
                </div>
                <footer onMouseOver={() => {
