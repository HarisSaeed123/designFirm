...
import img from "../assets/9) Lobby.jpg"
import img1 from "../assets/sehar/2) MEETING ROOM.jpg"
import img2 from "../assets/nafeesa/Featured Wall.jpg"
import img3 from "../assets/nafeesa/Meeting Room.jpg"
...
c3.3-11,21.2-26.6,49.8-26.6c35.5,0,63.3,23,63.3,72.4V508.1z"/>
        ...
        <div className="sideBarPhone">
          ...
          <dir>
            ...
            <div className="mainProductPage" onMouseOver={() => {
                document.getElementById('menuLinks').classList.remove('show')
            }}>


                <div className='websiteHeading4'>
                    <h1>ATELIER / 75</h1>
                    <hr />
                </div>
                <div className="expertiseProduct">
                    <h1><span>Expertise</span> / Commercial</h1>
                </div>
                <div className="productImage">
                    <img src={img} alt="" />
                </div>
                <div className='aboutProductDesign'>
                    <h1>Commercial at Atelier 75</h1>
                    <hr />
                    <p>Welcome to our commercial architectural design section, where creativity meets functionality to shape inspiring spaces for businesses. Whether it's modern offices or captivating retail environments, our team of experts crafts innovative solutions tailored to your brand identity. <span id="text12">With an emphasis on sustainability, our designs not only benefit your business but also contribute positively to the environment. Let's embark on a journey together, creating spaces that inspire and elevate your business to new heights. Through a meticulous and thoughtful approach, we integrate cutting-edge design principles, sustainable practices, and advanced technologies to craft commercial spaces that inspire and engage.</span></p>
                    <span id='more10' onClick={() => {
                ...
                <div className="community4">
                    <h1>We defined the modern office, and with every project we are refining it.</h1>
                    <p>Our portfolio showcases cutting-edge developments in workplace design, ranging from the column free office plan to state of the art, energy efficient, smart, and sustainable high rises and tech campuses</p>
                    <p><span id='text14'>Because the nature of work is always changing, we design for flexibility: we seek to anticipate organizational growth and facilitate new ways of working. Each studio in our firm is engaged in commercial projects, putting us at the forefront of emerging trends in local markets around the world.</span></p>
                    <span id='more11' onClick={() => {
                    ...
                    <img src={img1} alt="" />
                    <h1>"Over the years, we have dedicated ourselves to refining state-of-the-art strategies. Our esteemed position as leaders in design, technology, and management within this premier market is a source of great pride for us."</h1>
                    <p>Haris Saeed | Commercial Practice Leader</p>
                    <img src={img2} alt="" />
                    <img src={img3} alt="" />
                </div>
                <footer onMouseOver={() => {
