...
import img1 from "../assets/01-3.jpg"
import img2 from "../assets/004.jpg"
import img3 from "../assets/02-2.jpg"
import img4 from "../assets/Living Room 3.jpg"
...
export default function Home() {
  ...
  const fullText1 = "Architecture | Interiors | Visualization"
  ...
  useEffect(() => {
    ...
    const timer = setInterval(() => {
      if (currentIndex < fullText1.length) {
        setText1(prevText => prevText + fullText1[currentIndex])
        currentIndex++
      } else {
        clearInterval(timer)
      }
              ...
              <li id="navLinks">
                ...
                >
                  <optgroup>
                    ...
                    <option value="architecture" id='ARCHITECTURE'><a href="/services/architecture">ARCHITECTURE</a></option>
...
c3.3-11,21.2-26.6,49.8-26.6c35.5,0,63.3,23,63.3,72.4V508.1z"/>
      ...
      <div className="imgsSlider" onMouseOver={() => {
        document.getElementById('menuLinks').classList.remove('show')
      }}>
        <Slider {...settings} speed={6000} fade>
          <div>
            <img src={img1} alt="" />
            <p id='first'>ATELIER <span id='seventy5'>{75}</span></p>
            <h3 id='architectInterior'>{text1}</h3>
          </div>
          <div>
            <img src={img2} alt="" />
          </div>
      ...
      <div className="types" onMouseOver={() => {
        document.getElementById('menuLinks').classList.remove('show')
        document.getElementById('spanLink').style.display  = "none"
      }} >
        <div className="architecture">
          <h1>ARCHITECTURE</h1>
          <p>Our design philosophy centers on creating buildings that embody simplicity and elegance, with spacious interiors that offer a blank canvas for the interplay of light and shadow. We strive to enhance the context in which these structures exist.</p>
        </div>

        <div className="interiors">
          <h1>INTERIORS</h1>
          <p>Our interiors prioritizes seamless connections between indoor and outdoor spaces, resulting in a fluid and cohesive aesthetic. This effect is enhanced by a thoughtful selection of materials, which though limited in palette, provide a rich array of textures and tones. </p>
        </div>

        <div className="productDesign">
          <h1>ARCHITECTURE VISUALIZATION</h1>
          <p>We offer architecture visualization services to showcase designs in a dynamic and immersive way,   with our photorealistic renderings and animations we acheive the level of detail and accuracy which enable our clients to explore and understand the designs from different perspective.</p>
        </div>
      </div>

      <div className="award" onMouseOver={() => {
        document.getElementById('menuLinks').classList.remove('show')
      }}>
      ...
      <div className="saadBashir" onMouseOver={() => {
        document.getElementById('menuLinks').classList.remove('show')
      }}>
        <div className="saad">
          <h1>UNPARALLELED, EXQUISITELY CRAFTED DESIGNS THAT EVOKE A SENSE OF WONDER AND JOY FOR THEIR USERS.</h1>

        </div>
      </div>

      <div className="coreValues" onMouseOver={() => {
        document.getElementById('menuLinks').classList.remove('show')
      }}>
        <div className="ourValues">
          <h6>OUR VALUES</h6>
          <p>We are committed to innovation and excellence and of thinking outside of the box to provide the best solutions for each project. We are also committed to sustainability and in acting in an environmentally friendly way, delivering our very best in all we do and holding ourselves accountable for all the results.</p>
        </div>
        <div className="ourMission">
          <h6>OUR MISSION</h6>
          <p>Our mission is to give each of our clients the best professional design service. We believe design has the potential to make you more focused, productive, and is a reflection of who you are. We believe in giving individual attention to each of our clients, and building solid, lasting relationships based on trust and satisfaction.</p>
        </div>

        <div className="ourSkills">
          <h6>OUR SKILLS</h6>
          <p>We believe that in our creative design process, there is little that separates Architecture, Interiors and Visualization. We have successfully produced designs on various scales, ranging from complex buildings to modern interiors and treat each project with the same degree of care and attention.</p>
        </div>
      </div>


      <div className="homeContact" onMouseOver={() => {
        document.getElementById('menuLinks').classList.remove('show')
      }}>
        ...
        <div className="connect">
          <Link to="/contact">CONTACT ATELIER 75</Link>
        </div>
      </div>
