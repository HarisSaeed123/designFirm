...
import img from "../assets/02-2.jpg"
import img1 from "../assets/render.jpg"
import img2 from "../assets/landscape.jpg"
import img3 from "../assets/arch2.jpg"
...
c3.3-11,21.2-26.6,49.8-26.6c35.5,0,63.3,23,63.3,72.4V508.1z"/>
        ...
        <div className="sideBarPhone">
          ...
          <dir>
            ...
            <div className="mainResidentialPage" onMouseOver={() => {
                document.getElementById('menuLinks').classList.remove('show')
            }}>


                <div className='websiteHeading9'>
                    <h1>ATELIER / 75</h1>
                    <hr />
                </div>
                <div className="expertiseResidential">
                    <h1><span>Expertise</span> / Residential</h1>
                </div>
                <div className="residentialImage">
                    <img src={img} alt="" />
                </div>
                <div className='aboutResidential'>
                    <h1>Residential at Atelier 75</h1>
                    <hr />
                    <p>What makes a home? How can a building foster community? We see each residential project as an opportunity to answer these questions. To find ways that new architecture can reinforce a sense of place, enhance the civic realm, and provide for the wellbeing of the people who live there.</p>
                </div>
                <div className="community9">
                    <h1>Strengthening community</h1>
                    <p>Residential projects are a pathway for building vibrant cities through a range of accessible housing options. Careful consideration for lifestyle and cultural context, as well as amenity, efficiency and aesthetics, are the cornerstones of success for these new communities.</p>
                    <p>We think about sustainability in the broadest sense: as an opportunity to reinforce connections to place, to nature, and to each other.</p>
                    <img src={img1} alt="" />
                    <h1>"We’re inspired to work as citizen architects, focused on a bigger picture and purpose. Through our design work and our role as industry leaders, we’re seizing the opportunity to respond to residential challenges."</h1>
                    <p>Yasemin Kologlu | Architect</p>
                    <img src={img2} alt="" />
                    <img src={img3} alt="" />
                </div>
                <footer onMouseOver={() => {
