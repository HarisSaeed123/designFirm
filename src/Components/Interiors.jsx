...
import img from "../assets/Living Room 3.jpg"
import img1 from "../assets/Scene 3.jpg"
import img2 from "../assets/sehar/4) CEO Room.jpg"
import img3 from "../assets/sehar/2) MEETING ROOM.jpg"
...
c3.3-11,21.2-26.6,49.8-26.6c35.5,0,63.3,23,63.3,72.4V508.1z"/>
      ...
      <div className="mainInteriorPage" onMouseOver={() => {
        document.getElementById('menuLinks').classList.remove('show')
      }}>
        <div className="websiteHeading1">
          <h1>ATELIER / 75</h1>
          <hr />
        </div>
        <div className="expertiseInterior">
          <h1><span>Expertise</span> / Interior</h1>
        </div>
        ...
        <div className="aboutInterior">
          <h1>Interiors at Atelier 75</h1>
          <hr />
          <p>By emphasizing the design of a building from both the inside-out and the outside-in, we foster a feeling of continuity and a strong connection to the surrounding environment. <span id='text3'>The primary step in any design approach is to grasp people's requirements and how they intend to utilize the space. The objective is to craft interiors that are not only practical and refined but also evoke a distinct sense of location, harmonizing seamlessly with the building's external appearance.</span></p>
          <span id='more4' onClick={() => {
            document.getElementById('text3').style.display = "block"
            document.getElementById('more4').style.display = "none"
            document.getElementById('less4').style.display = "block"
          }}>See More...</span>
          <span id='less4' onClick={() => {
        ...
        <div className="community1">
          <h1>Bold, visionary design can help people reach their full potential.</h1>
          <p>Our design philosophy revolves around creating spaces that are forward thinking, anticipating, accommodating new lifestyles, work patterns, and educational paradigms. Our commitment lies in providing an enduring value through our designs. <span id='text4'>With a diverse interior design portfolio spanning workplaces, hospitality venues, residential areas and higher education facilities, our clients gain our multidisciplinary proficiency. Our collaborative teams are adept at forging meaningful connections between individuals and their environments, ensuring that building performance aligns seamlessly with the human experience.</span></p>

          <p><span id='text5'>Our studio reimagines what an interior environment can achieve. For years, we have been continuously pushing the boundaries of interiors to create groundbreaking designs that have revolutionized the way we live and work.</span></p>
          <span id='more5' onClick={() => {
            document.getElementById('text4').style.display = "block"
            document.getElementById('text5').style.display = "block"
            document.getElementById('more5').style.display = "none"
            document.getElementById('less5').style.display = "block"
          }}>See More...</span>
          <span id='less5' onClick={() => {
          ...
          <img src={img1} alt="" />
          <h1>"Through a comprehensive emphasis on sustainability, health, and well-being, we are envisioning our clients a whole new dimension of interior environments."</h1>
          <p>M.Ghufran | Interior Designer</p>
          <img src={img2} alt="" />
          <img src={img3} alt="" />
        </div>
        <footer onMouseOver={() => {
