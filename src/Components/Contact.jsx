...
export default function Contact() {
  ...
  const fullText = "LET'S BUILD SOMETHING REMARKABLE!"
  useEffect(() => {
    let currentIndex = 0;
  ...
  const sendEmail = (e) => {
    ...
    let emailId = document.getElementById('gmail').value
    if (uname === "" || emailId === "") {
      e.preventDefault();
      let x = document.getElementById('Username')
      let y = document.getElementById('gmail')
      x.placeholder = "The field is required."
      y.placeholder = "The field is required."

    } else {
      e.preventDefault();
      emailjs.sendForm('service_1r1kjns', 'template_ltah81o', e.target, 'JXFiF9BuzRJARHO7f')
        .then((result) => {
...
c3.3-11,21.2-26.6,49.8-26.6c35.5,0,63.3,23,63.3,72.4V508.1z"/>
      ...
      <div className="box" onMouseOver={() => {
        ...
        <div className="address">
          <p>602-D Eden Towers, Main Boulevard Gulberg |||</p>
          <p id='lahore'>Lahore, Pakistan</p>
        </div>
      </div>


      <div className="form" onMouseOver={() => {
        document.getElementById('menuLinks').classList.remove('show')
      }}>
        <form ref={form} onSubmit={sendEmail}>
          <div className="name">
            <label htmlFor="Username">Your Name (required)</label><br /><br />
            <input type="text" name="username" id="Username" placeholder='' required />
          </div>
          <div className="Email">
            <label htmlFor="gmail">Your Email (required)</label><br /><br />
            <input type="email" name="useremail" id="gmail" placeholder='' requiredN />
          </div>
          ...
          <div className="message">
            ...
            <textarea name="message" id="textarea" cols="150" rows="10"></textarea>
          </div>
