...
import img from "../assets/ISO 1.jpg"
import img1 from "../assets/night render.jpg"
import img2 from "../assets/urban1.png"
import img3 from "../assets/urban.png"
    ...
    return (
        <>
            ...
            <ul id='menuLinks' className='menuList'>
                ...
                <li><Link to="">URBAN DESIGN + PLANNING</Link></li>
...
c3.3-11,21.2-26.6,49.8-26.6c35.5,0,63.3,23,63.3,72.4V508.1z"/>
        ...
        <div className="sideBarPhone">
          ...
          <dir>
            ...
            <div className="mainUrbanPage" onMouseOver={() => {
                document.getElementById('menuLinks').classList.remove('show')
            }}>


                <div className='websiteHeading3'>
                    <h1>ATELIER / 75</h1>
                    <hr />
                </div>
                <div className="expertiseUrban">
                    <h1><span>Expertise</span> / Urban Design + Planning</h1>
                </div>
                <div className="urbanImage">
                    <img src={img3} alt="" />
                </div>
                <div className='aboutUrban'>
                    <h1>Urban Design + Planning at Atelier 75</h1>
                    <hr />
                    <p>Designing at the urban scale is a complex undertaking, whether it involves a masterplan for a city, a regeneration scheme for a neighbourhood, or planning a new public transport system. <span id="text9">Our team includes planners, spatial designers, economists, anthropologists, landscape architects and mobility engineers, working together to create thriving and resilient environments. In this era of unprecedented social, technological, and environmental change, our approach anticipates the evolutionary changes and rapid transformation that shape our urban environments.</span></p>
                    <span id='more8' onClick={() =>{
                        document.getElementById('text9').style.display = "block"
                        document.getElementById('more8').style.display = "none"
                        document.getElementById('less8').style.display = "block"
                    }}>See More...</span>
                    <span id='less8'  onClick={() =>{
                        document.getElementById('text9').style.display = "none"
                        document.getElementById('more8').style.display = "block"
                        document.getElementById('less8').style.display = "none"
                    }}>See Less...</span>
                </div>
                <div className="community3">
                    <h1>Envisioning regenrative cities for a healthy planet</h1>
                    <p>Our extensive knowledge in urban design, architecture, and engineering, we harness the complete capabilities of our interdisciplinary firm. This empowers us to undertake projects of varying <span id='text10'>scales, ranging from site specific interventions to master plans for urban districts and even regional strategies concerning energy, mobility, and resilience. Our ultimate aim is to drive forward a sustainable and resilient future.</span></p>
                    <p><span id='text11'>In our quest to address the intricate issues confronting cities worldwide, we constantly seek innovative solutions to achieve a harmonious balance between the built and natural environment. </span></p>
                    <span id='more9' onClick={() =>{
                        ...
                        document.getElementById('less9').style.display = "block"
                    }}>See More...</span>
                    <span id='less9' onClick={() =>{
                        ...
                        document.getElementById('less9').style.display = "none"
                    }}>See Less...</span>
                    <img src={img} alt="" />
                    <h1>“There has never been a more important moment to work together in solving the world’s most pressing problems and holistically address planetary health.”</h1>
                    <p>Doug Voigt | Urban Planner</p>
                    <img src={img2} alt="" />
                    <img src={img1} alt="" />
                </div>
                <footer onMouseOver={() => {
